...
public record DialogueResponse {
    private static readonly IEnumerable<IDialogueResponsePreProcessor> PreProcessors = [
        new InvalidStringFixer(),
        new ScriptNotesParser(),
    ];

    private static readonly IEnumerable<IDialogueResponsePostProcessor> PostProcessors = [
