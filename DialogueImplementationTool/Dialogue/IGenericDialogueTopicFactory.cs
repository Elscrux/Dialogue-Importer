...
public class NewDialogueTopicFactory(IDialogueContext context) : IGenericDialogueTopicFactory {
...
public class ExistingDialogueTopicFactory(DialogTopic dialogTopic) : IGenericDialogueTopicFactory {
    public DialogTopic Create(IQuestGetter quest, DialogueTopicInfo topicInfo) {
        return dialogTopic;
    }
}
